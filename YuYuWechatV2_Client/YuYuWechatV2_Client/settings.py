...
AUTO_START_CELERY_ON_WEB_START = True
AUTO_START_CELERY_DELAY_SECONDS = 30
AUTO_START_CELERY_STOP_WAIT_SECONDS = 2
CELERY_EXECUTABLE = 'celery'
CELERY_PROCESS_PATTERN = r'celery.*YuYuWechatV2_Client'
